...
import me.dizzy.dizzyflipper.tweaker.transformers.GuiContainerTransformer;
import me.dizzy.dizzyflipper.tweaker.transformers.ITransformer;
...
public class DizzyFlipperTransformer implements IClassTransformer {
    static {
    ...
    public DizzyFlipperTransformer() {
