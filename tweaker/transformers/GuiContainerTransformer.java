package me.dizzy.dizzyflipper.tweaker.transformers;

import me.dizzy.dizzyflipper.tweaker.utils.TransformerClass;
import me.dizzy.dizzyflipper.tweaker.utils.TransformerMethod;
                ...
                while (iterator.hasNext()) {
                    ...
                    if (abstractNode instanceof MethodInsnNode && abstractNode.getOpcode() == Opcodes.INVOKESPECIAL) {
                        ...
                        if (methodInsnNode.owner.equals(TransformerClass.GuiContainer.getNameRaw()) && TransformerMethod.drawSlot.matches(methodInsnNode)) {
                            methodNode.instructions.insert(abstractNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "me/dizzy/dizzyflipper/tweaker/hooks/GuiContainerHook",
