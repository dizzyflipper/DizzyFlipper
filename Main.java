...
import me.dizzy.dizzyflipper.events.OnGuiOpen;
...
import me.dizzy.dizzyflipper.utils.updater.GitHub;
...
public class Main {
    ...
    public static DizzyCommand commandManager = new DizzyCommand(new Subcommand[]{
        new Toggle(),
        new Help(),
        new Token()
    });
    ...
    public void init(FMLInitializationEvent event) {
        ProgressManager.ProgressBar progressBar = ProgressManager.push("Dizzy Flipper", 4);
        ...
        try {
            ...
            e.printStackTrace();
            Reference.logger.error("Dizzy Flipper has been disabled due to an error while authenticating. Please check the logs for more information.");
            return;
        }
