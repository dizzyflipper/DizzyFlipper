package me.dizzy.dizzyflipper.utils;
...
import me.dizzy.dizzyflipper.objects.BestSellingMethod;
...
public class Utils {
    ...
    public static JsonElement getJson(String jsonUrl) throws IOException {
        ...
        conn.setRequestProperty("User-Agent", "DizzyFlipper/1.0");
    ...
    public static void sendMessageWithPrefix(String message) {
        UChat.chat(EnumChatFormatting.GOLD + ("[DIZZY] ") + message.replaceAll("&", "§"));
    }

    public static void sendMessageWithPrefix(String message, ClickEvent clickEvent) {
        UTextComponent result = new UTextComponent(EnumChatFormatting.GOLD + ("[DIZZY] ") + message.replaceAll("&", "§"));
